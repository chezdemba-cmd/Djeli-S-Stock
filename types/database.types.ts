  ...
  public: {
    Tables: {
      ...
      profiles: {
        ...
        Insert: { id: string; is_super_admin?: boolean; }
        Update: { id?: string; is_super_admin?: boolean; }
        Relationships: { foreignKeyName: string; columns: string[]; isOneToOne?: boolean; referencedRelation: string; referencedColumns: string[]; }[]
      }
      stores: {
    ...
    Functions: {
      ...
      create_sale: { Args: Record<string, any>; Returns: any; }; pay_receivable: { Args: Record<string, any>; Returns: any; }; current_orgs: {
        Args: Record<string, never>;
        Returns: string[];
      };
    }
